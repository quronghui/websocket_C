...
char ip[] = "192.168.0.113";//"192.168.244.128";       // 本机IP
int port = 8080;
...
int main(void)
{
    ...
    fd = webSocket_clientLinkToServer(ip, port, "/web/websocket/socketServer"); //This is client request's things, we need only change it.(before is null)
    if(fd <= 0)
    {
